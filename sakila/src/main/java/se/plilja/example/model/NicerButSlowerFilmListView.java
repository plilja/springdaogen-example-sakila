...
@Repository
public class NicerButSlowerFilmListView extends Queryable<NicerButSlowerFilmList> {
    ...
    @Autowired
    public NicerButSlowerFilmListView(NamedParameterJdbcTemplate jdbcTemplate) {
